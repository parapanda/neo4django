"""
The neo4django2 test suite. Currently, these are rough development-oriented tests,
...
def setup():
    global Person, neo4django2, gdb, neo4jrestclient, neo_constants, settings, models

    from neo4django2.tests import Person, neo4django2, gdb, neo4jrestclient, \
...
def test_custom_manager():
    ...
    class MyCustomManager(neo4django2.db.models.manager.NodeModelManager):
...
def test_model_casting():
    ...
    class Doppelganger(models.NodeModel):
        ...
        original = models.Relationship(Person,
                                           rel_type=neo4django2.Outgoing.MIMICS,
                                           single=True)
    #create a person
...
def test_model_copy():
    class NameOwner(models.NodeModel):
        name = models.StringProperty()
        confidantes = models.Relationship(Person, neo4django2.Outgoing.KNOWS)
