...
def setup():
    global Person, neo4django2, gdb, neo4jrestclient, neo_constants, settings,\
...
def test_integer():
    ...
    for i in [0,1,-1,28,neo4django2.db.models.properties.MAX_INT,neo4django2.db.models.properties.MIN_INT]:
        try_int(i)
