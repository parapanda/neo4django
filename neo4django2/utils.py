...
def load_client(client_path):
    """
    Imports a custom subclass of `neo4django2.neo4jclient.EnhancedGraphDatabase`. The
...
class ConnectionHandler(object):
    ...
    def ensure_defaults(self, alias):
        ...
        conn.setdefault('CLIENT', 'neo4django2.neo4jclient.EnhancedGraphDatabase')
        if conn['CLIENT'] == 'django.db.backends.' or not conn['CLIENT']:
            conn['CLIENT'] = 'neo4django2.neo4jclient.EnhancedGraphDatabase'
